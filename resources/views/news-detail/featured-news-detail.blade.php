				...
				<div class="col-md-8">
					<div class="news-detail-post">
						<div class="title text-center mb-4">
							...
							<span class="post-date"><i class="far fa-calendar-alt mr-2"></i>{{$date}}</span>
						</div>
				...
				<div class="col-md-4">
					<div class="sidebar sidebar-tab mb-5">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="newsletter-tab" data-toggle="tab" href="#Newsletter" role="tab" aria-controls="Newsletter" aria-selected="false">Latest Publication</a>
							</li>
						</ul>
