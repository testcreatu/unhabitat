	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit Client</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{url('cd-admin/updateClient/'.$data['id'])}}" enctype="multipart/form-data" role="form">
				@csrf
				<div class="form-body">
					...
					<div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="url" name="url" class="form-control" placeholder="Enter Logo URL" value="{{$data['url']}}">
						</div>
					</div>
