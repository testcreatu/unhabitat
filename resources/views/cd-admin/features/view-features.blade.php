				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td>{!!$features->summary!!}</td>
							<td>@if($features->status == 'active')
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-left" role="menu">
										<li>
											<a data-toggle="modal" href="#view-modal{{$features->id}}">
												<i class="fa fa-eye"></i> View
											</a>
										</li>
										<li>
											<a href="{{url('cd-admin/edit-features/'.$features->id)}}">
												<i class="fa fa-edit"></i> Edit
											</a>
										</li>
										<li>
											<a data-toggle="modal" href="#delete-modal{{$features->id}}">
