	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit Events</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="POST" action="{{url('/cd-admin/edit-events/'.$data['id'])}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
					@csrf
					...
					<div class="form-group{{ $errors->has('event_date') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="date" name="event_date" class="form-control" placeholder="Enter Event Date" value="{{$data['event_date']}}">
						</div>
					</div>
					...
					<div class="form-group{{ $errors->has('event_time') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<input type="text" name="event_time" class="form-control" placeholder="Enter Event Time" value="{{$data['event_time']}}">
						</div>
					</div>
