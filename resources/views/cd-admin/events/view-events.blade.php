...
@if(Session::has('EventDeleteSuccess'))
<div class="alert alert-danger">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Event DELETED SUCCESSFULLY!!!</strong> {{ Session::get('message', '') }}
</div>
@elseif(Session::has('EventSuccess'))
<div class="alert alert-success">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Event INSERTED SUCCESSFULLY!!!</strong> {{ Session::get('message', '') }}
</div>

@elseif(Session::has('EventUpdateSuccess'))
<div class="alert alert-success">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Event UPDATED SUCCESSFULLY!!!</strong> {{ Session::get('message', '') }}
</div>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				...
				<div class="btn-group pull-right">
					<a href="{{url('cd-admin/add-events')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add Event
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-left" role="menu">
										...
										<li>
											<a href="{{url('cd-admin/edit-events/'.$c->id)}}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="panel panel-default">
					<div class="panel-heading"> Event Date </div>
					<div class="panel-body"> {!!$ch->event_date!!} </div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading"> Event Time </div>
					<div class="panel-body"> {!!$ch->event_time!!} </div>
				</div>
				<div class="panel panel-default">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{url('/cd-admin/delete-events/'.$c->id)}}"  class="btn green">YES</a>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
