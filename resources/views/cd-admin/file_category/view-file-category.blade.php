...
@if(Session::has('FilesCategoryDeleteSuccess'))
<div class="alert alert-danger">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Files Category DELETED SUCCESSFULLY!!!</strong> {{ Session::get('message', '') }}
</div>
@elseif(Session::has('FilesCategorySuccess'))
<div class="alert alert-success">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Files Category INSERTED SUCCESSFULLY!!!</strong> {{ Session::get('message', '') }}
</div>

@elseif(Session::has('FilesCategoryUpdateSuccess'))
<div class="alert alert-success">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Files Category UPDATED SUCCESSFULLY!!!</strong> {{ Session::get('message', '') }}
</div>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View Files Category </span>
				</div>
				<div class="btn-group pull-right">
					<a href="{{url('cd-admin/add-file-category')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add Files Category
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-left" role="menu">
										...
										<li>
											<a href="{{url('cd-admin/edit-file-category/'.$c->id)}}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{url('/cd-admin/delete-file-category/'.$c->id)}}"  class="btn green">YES</a>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
