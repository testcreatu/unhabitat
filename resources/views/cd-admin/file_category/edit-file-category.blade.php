...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-file-category')}}">View File Category</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
			<span>Edit File Category</span>
		</li>
	</ul>
</div>
<!-- END PAGE BAR -->
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit File Category</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="POST" action="{{route('edit-file-category',$data['id'])}}" enctype="multipart/form-data" role="form">
				<div class="form-body">
					@csrf
