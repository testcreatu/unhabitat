...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-projects')}}">View Project</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Add Project</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{route('add-projects')}}" enctype="multipart/form-data" role="form">
				@csrf
				<div class="form-body">
						...
						<div class="col-md-6">
							<div class="mt-radio-inline">
								<label class="mt-radio">
									<input type="radio" name="project_status" id="optionsRadios25" value="ongoing" checked> OnGoing
									<span></span>
								</label>
								<label class="mt-radio">
									<input type="radio" name="project_status" id="optionsRadios26" value="completed" > Completed
									<span></span>
								</label>
							</div>
						</div>
					...
					<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
						<label class="col-md-3 control-label">Enter Project Title <span class="cd-admin-required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter Project title" name="title" value="{{old('title')}}">
						</div>
						@if ($errors->has('title'))
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="mt-radio-inline">
								<label class="mt-radio">
									<input type="radio" name="is_trending" id="optionsRadios25" value="yes" > Yes
									<span></span>
								</label>
								<label class="mt-radio">
									<input type="radio" name="is_trending" id="optionsRadios26" value="no" checked=""> No
									<span></span>
								</label>
							</div>
						</div>
