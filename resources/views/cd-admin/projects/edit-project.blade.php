...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-blog')}}">View Projects</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit Projects</span>
			</div>
		</div>
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{route('edit-projects',$data['id'])}}" enctype="multipart/form-data" role="form">
				@csrf
				<div class="form-body">
						...
						<div class="col-md-6">
							<div class="mt-radio-inline">
								<label class="mt-radio">
									<input type="radio" name="project_status" id="optionsRadios25" value="ongoing" <?php echo $data['project_status'] == 'ongoing'?'checked':'' ?>> OnGoing
									<span></span>
								</label>
								<label class="mt-radio">
									<input type="radio" name="project_status" id="optionsRadios26" value="completed" <?php echo $data['project_status'] == 'completed'?'checked':'' ?>> Completed
									<span></span>
								</label>
							</div>
						</div>
					...
					<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
						<label class="col-md-3 control-label">Enter Projects Title<span class="cd-admin-required">*</span></label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Is Trending</label>
						<div class="col-md-6">
							<div class="mt-radio-inline">
								<label class="mt-radio">
									<input type="radio" name="is_trending" id="optionsRadios25" value="yes" <?php echo $data['is_trending'] =='yes'?'checked':'' ?> > Yes
									<span></span>
								</label>
								<label class="mt-radio">
									<input type="radio" name="is_trending" id="optionsRadios26" value="no" <?php echo $data['is_trending'] =='no'?'checked':'' ?> > No
									<span></span>
								</label>
							</div>
						</div>
